...
export const metadata: Metadata = {
  ...
  "Top software development agency delivering custom software, mobile apps, cloud solutions, and secure digital products for growing businesses and startups.",
    ...
    openGraph: {
    title: "Fyris - We make Software Solutions for your business and Startups",
    description:
      "software development agency in India offering AI-powered solutions, custom software, mobile apps, cloud services, and cybersecurity solutions.",
    url: "https://www.fyris.in",
    siteName: "Fyris",
    images: [
      {
        url: "/og-image.jpg",
