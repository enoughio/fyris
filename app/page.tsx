...
export const metadata: Metadata = {
  ...
  description:
    "Leading software development agency in M.P offering AI-powered solutions, custom web development, mobile apps, cloud services, and cybersecurity solutions.",
    keywords:
